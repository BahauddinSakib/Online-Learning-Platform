      ...
      <DialogDescription asChild>
         <div className='flex flex-col gap-4 mt-3'>
            ...
            <div>
                ...
                <Textarea placeholder="Course Description" onChange={(event)=>onHandleInputChange('courseDescription',event?.target.value)}/>
            </div>
            <div>
                <label>No. of Chapters</label>
                <Textarea placeholder="No. of chapters" type='number'
